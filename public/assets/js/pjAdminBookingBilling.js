...
(function ($, undefined) {
    $(function () {
        ...
        if ($("#grid").length > 0 && datagrid) {
            ...
            var $grid = $("#grid").datagrid({
                ...
                dataUrl:
                    isRedirected
                        ?
                        "index.php?controller=pjAdminBookings&action=pjActionGetBookings&billing=true" + '&' + gridQuery
                        :
                        "index.php?controller=pjAdminBookings&action=pjActionGetBookings&billing=true",
                dataType: "json",
                fields: ['booking_id', 'pick_drop_actual', 'type', 'car_info', 'client', 'total_price', 'status', 'booking_payment_status', 'insurance_type', 'bill_for_insurance', 'ref', 'insurance_flag'],
                paginator: {
                    gotoPage: true,
                    paginate: true,
                    total: true,
        ...
        $(document).on("click", ".btn-all", function (e) {
            ...
            $grid.datagrid("load", "index.php?controller=pjAdminBookings&action=pjActionGetBookings&billing=true" + pjGrid.queryString, "created", "DESC", content.page, content.rowCount);
            return false;
            ...
            $grid.datagrid("option", "cache", cache);
            $grid.datagrid("load", "index.php?controller=pjAdminBookings&action=pjActionGetBookings&billing=true", "created", "DESC", content.page, content.rowCount);
            return false;
